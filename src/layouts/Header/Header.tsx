        ...
        <header className="header">
            ...
            <div className="header__right">
                ...
                <div className="header__controls">
                    <button className="header__icon-button" onClick={toggleTheme} title={theme === 'light' ? '다크 모드로 전환' : '라이트 모드로 전환'}>
                        {theme === 'light' ? '🌙' : '☀️'}
                    </button>
                    <button className="header__icon-button" onClick={toggleContrast} title={contrast === 'standard' ? '고대비 모드 켜기' : '고대비 모드 끄기'}>
                        {contrast === 'standard' ? '👁️' : '👓'}
                    </button>
                </div>
            </div>
